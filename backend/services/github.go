...
func (s *GitHubService) GetLanguages() ([]models.GitHubLanguage, error) {
	url := "https://github.com/trending"
	...
	var languages []models.GitHubLanguage

	// 查找语言筛选下拉菜单中的所有选项
	doc.Find("div#languages-menuitems div a span").Each(func(i int, s *goquery.Selection) {
		name := strings.TrimSpace(s.Text())
		if name == "" {
			return
		}

		language := models.GitHubLanguage{
			Name: name,
			URL:  "https://github.com/trending/" + name,
		}
